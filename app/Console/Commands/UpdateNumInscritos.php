...
class UpdateNumInscritos extends Command
{
     ...
     */
    protected $description = 'Atualiza o número estimado de alunos inscritos (estmtr) das turmas a partir do Replicado.';
    ...
    public function handle(): int
    {
        ...
        if ($falhas > 0) {
            ...
            $this->info('Atualização do número de inscritos concluída com sucesso para ' . $turmas->count() . ' turma(s).');
        }
